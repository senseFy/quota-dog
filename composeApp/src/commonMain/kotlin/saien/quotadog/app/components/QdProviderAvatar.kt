...
import quotadog.composeapp.generated.resources.provider_droid
...
fun QdProviderAvatar(
    ...
    val tint = when (provider) {
        ...
        ProviderId.DROID -> colors.droidAccent
    }
    val icon = when (provider) {
        ...
        ProviderId.DROID -> Res.drawable.provider_droid
    }
